...
const CREATE_INDEX_REVIEWS_AUTHOR = `CREATE INDEX IF NOT EXISTS reviews_author_idx ON ${REVIEWS}(author);`;

const CREATE_INDEX_PRICING_PLANS_PRICE = `CREATE INDEX IF NOT EXISTS pricing_plans_price_idx ON ${PRICING_PLANS}(price);`;

const CREATE_UNIQUE_INDEX_APPS_ID = `CREATE UNIQUE INDEX IF NOT EXISTS apps_id_unq_idx ON ${APPS}(id);`;
